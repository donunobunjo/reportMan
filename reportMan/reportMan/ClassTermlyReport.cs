...
namespace reportMan
{
    public partial class ClassTermlyReport : Form
    {
        int totalInClass;
        decimal grandTotalScore, classavgg;
        public ClassTermlyReport()
        {
            InitializeComponent();
        }

        private void ClassTermlyReport_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
           ...
           // Int64 count, avg;
            ...
            reportManDataSetTableAdapters.distinctStudentsTableAdapter rss = new reportManDataSetTableAdapters.distinctStudentsTableAdapter();
            reportManDataSetTableAdapters.SumGrandTotalTableAdapter gtot = new reportManDataSetTableAdapters.SumGrandTotalTableAdapter();
            DataTable dtr = new DataTable();
            DataTable dtrss = new DataTable();
            dtr = ord.GetData();
            dtrss = rss.GetData();
            totalInClass = dtrss.Rows.Count;
            grandTotalScore = (decimal)gtot.ScalarQuery();
            classavgg = grandTotalScore / totalInClass;
            decimal scr0 = 0;
            //int maincardposn = 1, mainmainposn = 1
            int counter = 1;
