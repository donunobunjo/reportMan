...
namespace reportMan
{
    public partial class StaffItemsRecieved : Form
    {
        public StaffItemsRecieved()
        {
            InitializeComponent();
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            this.staffInventoryTableAdapter.InsertQuery(comboBox1.Text, textBox1.Text, qty, 0, textBox3.Text, DOT);
            this.Close();
        }
