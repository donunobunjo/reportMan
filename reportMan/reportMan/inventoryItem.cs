...
namespace reportMan
{
    public partial class inventoryItem : Form
    {
        ...
        {
            reportManDataSetTableAdapters.InventoryItemTableAdapter invItems = new reportManDataSetTableAdapters.InventoryItemTableAdapter();
            if (comboBox1.Text == "")
            {
            ...
            invItems.InsertQuery(comboBox1.Text, textBox2.Text);
            this.Close();
        }
