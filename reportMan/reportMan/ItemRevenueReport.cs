...
namespace reportMan
{
    public partial class ItemRevenueReport : Form
    {
        public ItemRevenueReport()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (radioButton1.Checked == true)
            {
               ...
               // this.ExpenseReportTableAdapter.FillByItemsTermly(this.reportManDataSet.ExpenseReport, comboBox1.Text, comboBox2.Text, "EXPENSE", comboBox4.Text);
                this.RevenueReportTableAdapter.FillByItemsTermlt(this.reportManDataSet.RevenueReport, comboBox1.Text, comboBox2.Text, "REVENUE", comboBox4.Text);
                this.reportViewer1.RefreshReport();
            }
            else if (radioButton2.Checked == true)
            {
                ...
                this.RevenueReportTableAdapter.FillByItemsSession(this.reportManDataSet.RevenueReport, comboBox3.Text, "REVENUE", comboBox4.Text);
            ...
            else if (radioButton3.Checked == true)
            {
               ...
               // this.ExpenseReportTableAdapter.FillByAllExpense(this.reportManDataSet.ExpenseReport, "EXPENSE",comboBox4.Text);
                this.RevenueReportTableAdapter.FillByAllRevenue(this.reportManDataSet.RevenueReport, "REVENUE", comboBox4.Text);
                this.reportViewer1.RefreshReport();
            }
            else
            {
