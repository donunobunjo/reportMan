...
namespace reportMan
{
    public partial class TermlyRevenueReport : Form
    {
        public TermlyRevenueReport()
        {
            InitializeComponent();
        }

        private void TermlyRevenueReport_Load(object sender, EventArgs e)
        {
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
           // this.ExpenseReportTableAdapter.FillByTermly(this.reportManDataSet.ExpenseReport, comboBox1.Text, comboBox2.Text, "EXPENSE");
            this.RevenueReportTableAdapter.FillByTermlyRevenue(this.reportManDataSet.RevenueReport, comboBox1.Text, comboBox2.Text, "REVENUE");
