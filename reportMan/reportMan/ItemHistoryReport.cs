        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (radioButton1.Checked == true)
            {
              ...
              //  this.ExpenseReportTableAdapter.FillByItemsTermly(this.reportManDataSet.ExpenseReport, comboBox1.Text, comboBox2.Text, "EXPENSE", comboBox4.Text);
                this.ItemsHistoryReportTableAdapter.FillByTermlyItems(this.reportManDataSet.ItemsHistoryReport, comboBox4.Text, comboBox1.Text, comboBox2.Text);
                this.reportViewer1.RefreshReport();
            }
            else if (radioButton2.Checked == true)
            {
              ...
              //  this.ExpenseReportTableAdapter.FillByItemsSession(this.reportManDataSet.ExpenseReport, comboBox3.Text, "EXPENSE", comboBox4.Text);
                ...
                this.ItemsHistoryReportTableAdapter.FillBySessionItems(this.reportManDataSet.ItemsHistoryReport,comboBox4.Text,comboBox3.Text);
            ...
            else if (radioButton3.Checked == true)
            {
               ...
               // this.ExpenseReportTableAdapter.FillByAllExpense(this.reportManDataSet.ExpenseReport, "EXPENSE",comboBox4.Text);
                this.ItemsHistoryReportTableAdapter.FillByAllItems(this.reportManDataSet.ItemsHistoryReport, comboBox4.Text);
                this.reportViewer1.RefreshReport();
            }
            else
            {
